...
extern "C"
{
    ...
    */
    HSI_API HSI_RETURN commonSaveCube (CubeFloat i_cube, wchar_t const* i_out_dir_path, wchar_t const* i_out_file_name, FileFormat i_out_file_format);
    ...
    */
    HSI_API HSI_RETURN commonLoadCube (CubeFloat* o_p_cube, wchar_t const* i_in_file_path);
    ...
    \retval HSI_FILE_IO_ERROR Could not write the data into the specified directory. Verify write permissions and disk space.
    */
    HSI_API HSI_RETURN commonSaveFrame (FrameFloat i_frame, wchar_t const* i_out_dir_path, wchar_t const* i_out_file_name, FileFormat i_out_file_format);
    ...
    */
    HSI_API HSI_RETURN commonLoadFrame (FrameFloat* o_p_frame, wchar_t const* i_in_file_path);
    ...
    \retval HSI_FILE_IO_ERROR i_in_file_path leads to a frame that cannot be read.
    */
    HSI_API HSI_RETURN commonSaveSpectrum (SpectrumFloat i_p_spectrum, wchar_t const* i_out_file_path, wchar_t const* i_out_file_name);
    ...
    \retval HSI_FILE_IO_ERROR i_in_file_path leads to a frame that cannot be read.
    */
    HSI_API HSI_RETURN commonLoadSpectrum (SpectrumFloat* o_p_spectrum, wchar_t const* i_in_file_path);
    ...
    */
    ...
    \retval HSI_FILE_SYSTEM_ERROR The specified directory doesn't exist and could not be created.
    */
    HSI_API HSI_RETURN commonInitializeLogger (wchar_t const* i_log_dir_path, LoggerVerbosity i_verbosity_level);
