...
extern "C"
{
    ...
    */
    const char EPOCH_STR [] = "1970/1/1"; ///< YYYY/MM/DD
    /*!
    ...
    */
    ...
    Starting from the most permissive (LL_DEBUG) to the least (LL_ERROR), each severity step reduces the output.
    Therefore, LL_ERROR only outputs errors while LL_INFO ouputs infos, warnings and errors.
    ...
    */
    typedef enum ReturnValue
    {
        ...
        HSI_DATA_NOT_VALID              = 33,   ///< Data with valid flag false provided as input for operation.
